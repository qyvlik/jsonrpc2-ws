...
import JsonRpcOnMessageInterceptor from './interceptors/JsonRpcOnMessageInterceptor.js';
import JsonRpcOnRequestInterceptor from "./interceptors/JsonRpcOnRequestInterceptor.js";
import JsonRpcOnConnectionInterceptor from './interceptors/JsonRpcOnConnectionInterceptor.js';
...
export default class JsonRpc {
    ...
    async request(method, params, websocket) {
        const that = this;
        const ws = that.role === 'client' ? that.ws : websocket;
    ...
    async notification(method, params, websocket) {
        const that = this;
        const ws = that.role === 'client' ? that.ws : websocket;
        if (ws == null || ws.readyState !== WebSocket.OPEN) {
            throw {jsonrpc, code: JSON_RPC_ERROR_LOST_CONNECTION, message: 'Lost connection!'};
